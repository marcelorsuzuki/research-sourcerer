 ...
 */
public class RepositoryProperties extends AbstractProperties {
  public Property<String> REPOSITORY_TYPE = new StringProperty("repo-type", this);
  
  public RepositoryProperties(RepoFile file) {
    super(file.toFile());
  }
}
