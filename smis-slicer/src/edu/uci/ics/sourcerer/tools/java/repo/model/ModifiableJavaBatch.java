 ...
 */
public interface ModifiableJavaBatch extends JavaBatch, ModifiableSourceBatch {
  @Override
  public ModifiableJavaProject getProject(Integer checkout);
  
  @Override
  public Collection<? extends ModifiableJavaProject> getProjects();
  
  @Override
  public ModifiableJavaProject createProject();
}
