 ...
 */
public interface ModifiableJavaRepository extends JavaRepository, ModifiableSourceRepository {
  @Override
  public Collection<? extends ModifiableJavaBatch> getBatches();
  
  @Override
  public ModifiableJavaProject getProject(String path);
  ...
  @Override
  public ModifiableJavaBatch createBatch();
