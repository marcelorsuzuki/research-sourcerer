...
import edu.uci.ics.sourcerer.tools.java.repo.model.extracted.ModifiableExtractedJavaBatch;

/**
 * @author Joel Ossher (jossher@uci.edu)
 */
class ExtractedJavaBatchImpl extends BatchImpl<ExtractedJavaProjectImpl> implements ModifiableExtractedJavaBatch {
  ExtractedJavaBatchImpl(AbstractRepository<ExtractedJavaProjectImpl, ?> repo, RepoFileImpl dir, Integer batch) {
