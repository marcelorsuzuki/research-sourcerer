 ...
 */
public interface ModifiableSourceRepository extends ModifiableRepository, SourceRepository {
  @Override
  public Collection<? extends ModifiableSourceBatch> getBatches();
  
  @Override
  public ModifiableSourceProject getProject(String path);
  ...
  @Override
  public ModifiableSourceBatch createBatch();
}
