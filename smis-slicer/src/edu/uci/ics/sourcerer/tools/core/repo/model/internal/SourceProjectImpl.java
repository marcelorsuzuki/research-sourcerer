 ...
 */
public final class SourceProjectImpl extends AbstractSourceProject<SourceRepositoryImpl, FileSetImpl> {
  protected SourceProjectImpl(SourceRepositoryImpl repo, ProjectLocationImpl loc) {
    super(repo, loc);
  }
